...
class TestIsModelAvailable:
    ...
    @patch("autodidact.setup_wizard.ollama.verify_model_loadable", return_value=True)
    ...
    @patch("autodidact.setup_wizard.ollama.verify_model_loadable", return_value=False)
